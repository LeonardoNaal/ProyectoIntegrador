<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebUTM.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebUTM.WebUTM.index" %>
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    ...
                    <div class="carousel-caption kb_caption">
                        <h3 data-animation="animated flipInX">Participa en actividades escolares o extraescolares</h3>
                        <div class="row">
                            <div class="col-md-6">
                                <h4 data-animation="animated flipInX">Consulta horarios</h4>
                                <br />
                                <div align="center">
                                    <img src="../Recursos/Images/calendario.png" width="84" height="84" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h4 data-animation="animated flipInX">¿Te interesa? Asiste</h4>
                                <br />
                                <div align="center">
                                    <img src="../Recursos/Images/Estrella.png" width="84" height="84" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Segunda imagen -->
                <div class="item">
                    <img src="/Recursos/Images/carousel2.jpg" alt="" class="img-responsive" width="84" height="84" />
                    <div class="carousel-caption kb_caption kb_caption_right">
                        <h3 data-animation="animated flipInX">¿Tienes algo que decir?</h3>
                        <h4 data-animation="animated flipInX">Agrega publicaciones y ve lo que otros publican</h4>
                    </div>
                </div>

                <!-- Tercera imagen -->
                <div class="item">
                    <img src="../Recursos/Images/pag2utm-dos-col-byn.jpg" alt="" class="img-responsive" />
                    <div class="carousel-caption kb_caption kb_caption_center">
                        <h3 data-animation="animated flipInX">Toda la información en tu celular</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div align="center">
                                    <img src="../Recursos/Images/15397737_10205811189278933_798189675_o.png" width="280" height="200" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <img src="../Recursos/Images/google.png" width="200" height="75" />
                            </div>
                            <div class="col-md-6">
                                <img src="../Recursos/Images/apple.png" width="200" height="75" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <asp:DataList ID="DataList2" runat="server" BackColor="White" BorderColor="Lime" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" RepeatColumns="1" RepeatDirection="Horizontal" ForeColor="Black" CellSpacing="4" DataKeyField="IDActividad">
                    ...
                    <ItemTemplate>
                        <div class="jumbotron well">
                            ...
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Nombre") %>' Font-Size="Large" Font-Bold="true" ForeColor="#3A6B25"></asp:Label></strong><br />
                            <br />
                ...
                <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="Lime" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" RepeatColumns="1" RepeatDirection="Horizontal" ForeColor="Black" CellSpacing="4" DataKeyField="IDPublicacion">
                    ...
                    <ItemTemplate>
                        <div class="jumbotron well">
                            ...
                            <div align="center">
                                <asp:Image ID="Image1" runat="server" Width="150px" Height="75px" ImageUrl='<%# "ImageHandler.ashx?ID="+ Eval("IDPublicacion") %>' ImageAlign="Middle" BorderStyle="Groove" CssClass="img-thumbnail" />
                            </div>
                            <br />
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="media">
                    ...
                    <hr />
                    <div class="carousel slide" id="carousel-854145">
                        <ol class="carousel-indicators">
                            <li data-slide-to="0" data-target="#carousel-854145"></li>
                            <li data-slide-to="1" data-target="#carousel-854145" class="active"></li>
                            <li data-slide-to="2" data-target="#carousel-854145"></li>
                        </ol>
                        <div class="carousel-inner">
                            <div class="item">
                                <img alt="Carousel Bootstrap First" src="../Recursos/Images/car1.png" height="500" />
                            </div>
                            <div class="item active">
                                <img alt="Carousel Bootstrap Second" src="../Recursos/Images/car2.png" height="500" />
                            </div>
                            <div class="item">
                                <img alt="Carousel Bootstrap Third" src="../Recursos/Images/car3.png" height="500" />
                            </div>
                        </div>
                        <a class="left carousel-control" href="#carousel-854145" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a><a class="right carousel-control" href="#carousel-854145" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
                    </div>
                    <hr />
                </div>
            </div>
